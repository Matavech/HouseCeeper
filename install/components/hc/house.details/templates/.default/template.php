							...
							<div class="card-footer">
								<form method="post" action="delete-headman" class="card-footer-item">
									<fieldset <?= $USER->IsAdmin() ? '' : 'disabled' ?>>
										...
										<button type="submit"
												class="button is-danger "><?= \Bitrix\Main\Localization\Loc::getMessage('HC_HOUSECEEPER_HOUSEDETAILS_WITHDRAW_AUTHORITY') ?></button>
									</fieldset>
								</form>
							</div>
						<?php } ?>
							...
							<?php foreach ($arResult['USER_LIST'] as $user) { ?>
								...
								<form method="post" action="add-headman"
									...
									<fieldset>
										...
										<button type="submit"
												class="button is-primary "><?= \Bitrix\Main\Localization\Loc::getMessage('HC_HOUSECEEPER_HOUSEDETAILS_CHOSE') ?></button>
									</fieldset>
								</form>
								</p>
							<?php } ?>
